...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail12.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail12.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;Outstanding ventilation with 6 LED fans</li>
                            <li>&#10149;Full transparent tempered glass front and side window panel</li>
                            <li>&#10149;Designed for gaming rigs</li>
                            <li>&#10149;Don’t be afraid to win</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail12.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
