...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail7.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail7.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;Tenth-generation quad-core Intel Core i5 processor</li>
                            <li>&#10149;Brilliant Retina display with True Tone technology</li>
                            <li>&#10149;Ultrafast SSD</li>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail7.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
