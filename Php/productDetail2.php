...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail2.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail2.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;The #1 Best-Selling Gaming Peripherals Manufacturer in the US</li>
                            <li>&#10149;Immersive, 7.1 Surround Sound for Positional Audio:   Outfitted with custom-tuned 50 millimeter drivers</li>
                            <li>&#10149;All-Day Comfort: Oval, cooling gel-infused</li>
                            <li>&#10149;A built-in an analog volume control wheel and mic mute switch</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail2.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
