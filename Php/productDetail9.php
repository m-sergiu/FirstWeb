...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail9.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail9.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;5120 x 1440 at 60Hz | 47.8 in x 4.3 in x 14.6 in</li>
                            <li>&#10149;Antiglare with 3H hardness | 1.07 billion colors</li>
                            <li>&#10149;Double the display: View your content from two different PC sources with Picture-by-Picture (PBP)</li>
                            <li>&#10149;One keyboard to do it all: Easily toggle between two different PCs with the Keyboard, Video and Mouse (KVM)</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail9.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
