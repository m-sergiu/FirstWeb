...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail6.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail6.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;Nvidia GeForce GTX 1060 6GB GDDR5 | powerful gaming performance</li>
                            <li>&#10149;Intel Core i7-8750H (up to 3. 9GHz) processor</li>
                            <li>&#10149;15. 6” high refresh rate 144Hz IPS-Type Display | Slim 5mm Bezel and 3ms response time gaming laptop</li>
                            <li>&#10149;16GB DDR4 2666MHz RAM | 256GB PCIe NVMe SSD + 1TB HDD | Windows 10 Home</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail6.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
