...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail5.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail5.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;1632 MHz Boost Clock (OC Mode) featuring 11GB GDDR5X 352-bit memory,</li>
                            <li>&#10149;GPU Tweak II makes monitoring performance and streaming easier than ever</li>
                            <li>&#10149;Delivering a maximum resolution of 7680 x 4320 for the ultimate 5K gaming experience</li>
                            <li>&#10149;5K Gaming and VR Ready with 2x HDMI 2.0, 2x DisplayPort 1.4</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail5.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
