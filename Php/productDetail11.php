...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail11.php"</script>';
        }else{
...
<div class="small-container single-product">
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <form method="post" action="productDetail11.php?action=add&id=<?php echo $row["id"];?>">
                <div class='row'>
                    <div class='col-2'>
                    ...
                    <div class="col-2">
                        ...
                        <br>
                        <p> <ul>
                            <li>&#10149;LEAVE YOUR PHONE BEHND: Galaxy Watch3 gives you the freedom to call, text, stream music and get notifications via Bluetooth connectivity</li>
                            <li>&#10149;BATTERY BUILT FOR ENDURANCE</li>
                            <li>&#10149;Wired mouse</li>
                            <li>&#10149;wo sizes, two finishes, three colors and, 50,000 plus¹ watch faces-with military-grade durability² and water resistance</li>
                        </ul>
                        </p>
                    </div>
                </div>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="productDetail11.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
