...
if (isset($_POST["add"])){
    if (isset($_SESSION["cart"])){
        ...
        if (!in_array($_GET["id"],$item_array_id)){
            ...
            echo '<script>window.location="productDetail1.php"</script>';
        }else{
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                ?>
                    ...
                    <form method="post" action="productDetail1.php?action=add&id=<?php echo $row["id"];?>">
                        <div class='row'>
                            <div class='col-2'>
                            ...
                            <div class="col-2">
                                ...
                                <br>
                                <p> <ul>
                                    <li>&#10149;8 Programmable buttons that you can setup macros/key bindings</li>
                                    <li>&#10149;Set up the 16,000 DPI sensor for your custom needs</li>
                                    <li>&#10149;Wired mouse</li>
                                    <li>&#10149;RGB Custom Settings</li>
                                </ul>
                                </p>
                            </div>
                        </div>
                    ...
                    if(!empty($_SESSION["cart"])){
                        ...
                        foreach ($_SESSION["cart"] as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><a href="productDetail1.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
